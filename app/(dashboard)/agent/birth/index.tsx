    ...
    <ThemedView style={styles.container}>
      ...
      <ThemedView style={styles.stepIndicator}>
        <ThemedText variant="secondary" size="sm" style={styles.stepText}>
          {currentStep === 1 ? t('agent.birth.step1') : 
           currentStep === 2 ? t('agent.birth.step2') : 
           t('agent.birth.step3')}
        </ThemedText>
          ...
          <ThemedCard style={styles.formCard}>
                ...
                <ThemedView key={index} variant="transparent" style={styles.firstNameRow}>
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <ThemedInput
                        placeholder={t('agent.birth.childFirstName')}
                        value={value}
                        onBlur={onBlur}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.childLastName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.birthPlaceName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.birthAddress')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
        ...
        {currentStep === 2 && (
          <ThemedCard style={styles.formCard}>
            <ThemedView variant="transparent" style={styles.cardHeader}>
              ...
              />
              <ThemedText size="lg" weight="semibold" style={styles.cardTitle}>
                {t('agent.birth.step2Title')}
              </ThemedText>
            </ThemedView>

            {/* Section Mère */}
            <ThemedText size="base" weight="semibold" style={styles.sectionSubtitle}>
              {t('agent.birth.motherInfo')}
            </ThemedText>

            {/* Prénoms de la mère */}
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.motherFirstNames')} *
              </ThemedText>
              {step2Form.watch('motherFirstNames')?.map((_, index) => (
                <ThemedView key={index} variant="transparent" style={styles.firstNameRow}>
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <ThemedInput
                        placeholder={t('agent.birth.motherFirstName')}
                        value={value}
                        onBlur={onBlur}
                        onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.motherLastName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.motherProfession')} *
              </ThemedText>
              <Controller
                control={step2Form.control}
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.motherProfession')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.motherAddress')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            {/* Section Père */}
            <ThemedText size="base" weight="semibold" style={styles.sectionSubtitle}>
              {t('agent.birth.fatherInfo')}
            </ThemedText>

            {/* Prénoms du père */}
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.fatherFirstNames')} ({t('common.optional')})
              </ThemedText>
              {(step2Form.watch('fatherFirstNames') || ['']).map((_, index) => (
                <ThemedView key={index} variant="transparent" style={styles.firstNameRow}>
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <ThemedInput
                        placeholder={t('agent.birth.fatherFirstName')}
                        value={value}
                        onBlur={onBlur}
                        onChangeText={onChange}
                        size="md"
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.fatherLastName')} ({t('common.optional')})
              </ThemedText>
              <Controller
                control={step2Form.control}
                name="fatherLastName"
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.fatherLastName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
                    size="md"
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.fatherProfession')} ({t('common.optional')})
              </ThemedText>
              <Controller
                control={step2Form.control}
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.fatherProfession')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
                    size="md"
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.fatherAddress')} ({t('common.optional')})
              </ThemedText>
              <Controller
                control={step2Form.control}
                name="fatherAddress"
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.fatherAddress')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
                    size="md"
        ...
        {currentStep === 3 && (
          <ThemedCard style={styles.formCard}>
            <ThemedView variant="transparent" style={styles.cardHeader}>
              ...
              />
              <ThemedText size="lg" weight="semibold" style={styles.cardTitle}>
                {t('agent.birth.step3Title')}
              </ThemedText>
            </ThemedView>

            {/* Témoin 1 */}
            <ThemedText size="base" weight="semibold" style={styles.sectionSubtitle}>
              {t('agent.birth.witness1')}
            </ThemedText>

            {/* Prénoms du témoin 1 */}
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.witness1FirstNames')} *
              </ThemedText>
              {(step3Form.watch('witness1FirstNames') || ['']).map((_, index) => (
                <ThemedView key={index} variant="transparent" style={styles.firstNameRow}>
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <ThemedInput
                        placeholder={t('agent.birth.witness1FirstName')}
                        value={value}
                        onBlur={onBlur}
                        onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.witness1LastName')} *
              </ThemedText>
              <Controller
                control={step3Form.control}
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.witness1LastName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.witness1Address')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            {/* Témoin 2 */}
            <ThemedText size="base" weight="semibold" style={styles.sectionSubtitle}>
              {t('agent.birth.witness2')}
            </ThemedText>

            {/* Prénoms du témoin 2 */}
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.witness2FirstNames')} *
              </ThemedText>
              {(step3Form.watch('witness2FirstNames') || ['']).map((_, index) => (
                <ThemedView key={index} variant="transparent" style={styles.firstNameRow}>
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <ThemedInput
                        placeholder={t('agent.birth.witness2FirstName')}
                        value={value}
                        onBlur={onBlur}
                        onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.birth.witness2LastName')} *
              </ThemedText>
              <Controller
                control={step3Form.control}
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.witness2LastName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.birth.witness2Address')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
        ...
        <ThemedView style={styles.actionsContainer}>
          {currentStep === 1 ? (
            <PressableButton
              ...
              accessibilityLabel={t('agent.birth.next')}
            >
              {t('agent.birth.next')}
            </PressableButton>
          ) : currentStep === 2 ? (
            ...
            <ThemedView variant="transparent" style={styles.twoButtonsRow}>
              ...
              <PressableButton
                ...
                accessibilityLabel={t('agent.birth.register')}
                style={styles.buttonHalf}
              >
                {t('agent.birth.register')}
              </PressableButton>
            </ThemedView>
          )}
        </ThemedView>
