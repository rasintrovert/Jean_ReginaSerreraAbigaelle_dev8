    ...
    <ThemedView style={styles.container}>
      ...
      <ThemedView style={styles.stepIndicator}>
        <ThemedText variant="secondary" size="sm" style={styles.stepText}>
          {currentStep === 1 ? t('agent.pregnancy.step1') : t('agent.pregnancy.step2')}
        </ThemedText>
      ...
      >
          ...
          <ThemedCard style={styles.formCard}>
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.motherFirstNames')} *
              </ThemedText>
                ...
                <ThemedView key={index} variant="transparent" style={styles.firstNameRow}>
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <ThemedInput
                        placeholder={t('agent.pregnancy.motherFirstName')}
                        value={value}
                        onBlur={onBlur}
              ...
              <Pressable onPress={addMotherFirstName} style={styles.addButton}>
                ...
                <ThemedText size="sm" style={{ color: theme.colors.primary, marginLeft: 8 }}>
                  {t('agent.pregnancy.addFirstName')}
                </ThemedText>
              </Pressable>
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.motherLastName')} *
              </ThemedText>
              <Controller
                control={step1Form.control}
                name="motherLastName"
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.pregnancy.motherLastName')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.pregnancy.motherPhone')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.motherPhoneAlt')}
              </ThemedText>
              <Controller
                control={step1Form.control}
                name="motherPhoneAlt"
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.pregnancy.motherPhoneAlt')}
                    value={value || ''}
                    onBlur={onBlur}
                    onChangeText={onChange}
                    size="md"
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.motherAddress')} *
              </ThemedText>
              <Controller
                control={step1Form.control}
                name="motherAddress"
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.pregnancy.motherAddress')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              ...
              <Controller
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.pregnancy.motherCity')}
                    value={value}
                    onBlur={onBlur}
                    onChangeText={onChange}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.motherDepartment')} *
              </ThemedText>
              <Controller
                control={step1Form.control}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.motherBloodGroup')} ({t('common.optional')})
              </ThemedText>
              <ThemedText variant="secondary" size="xs" style={styles.helpText}>
                {t('agent.pregnancy.bloodGroupHelp')}
              </ThemedText>
              <Controller
                control={step1Form.control}
                ...
                render={({ field: { onChange, value } }) => (
                  <ThemedView variant="transparent" style={styles.pickerContainer}>
                    ...
                    >
                      ...
                      >
                        {value || t('agent.pregnancy.motherBloodGroup')}
                      </ThemedText>
                      <FontAwesome name="chevron-down" size={16} color={theme.colors.textSecondary} />
                    </Pressable>
                      ...
                      >
                        <ThemedView style={styles.modalContent}>
                          <ThemedView variant="transparent" style={styles.modalHeader}>
                            <ThemedView variant="transparent" style={styles.modalHeaderText}>
                              <ThemedText size="lg" weight="bold" style={styles.modalTitle}>
                                {t('agent.pregnancy.motherBloodGroup')}
                              </ThemedText>
        ...
        {currentStep === 2 && (
          <ThemedCard style={styles.formCard}>
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.estimatedDeliveryFull')} *
              </ThemedText>
              <Controller
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.estimatedDeliveryMonth')} *
              </ThemedText>
              <Controller
                control={step2Form.control}
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.pregnancyCount')} *
              </ThemedText>
              <ThemedText variant="secondary" size="xs" style={styles.helpText}>
                {t('agent.pregnancy.pregnancyCountHelp')}
              </ThemedText>
              <Controller
                control={step2Form.control}
                name="pregnancyCount"
            ...
            <ThemedView variant="transparent" style={styles.inputContainer}>
              <ThemedText size="sm" weight="medium" style={styles.label}>
                {t('agent.pregnancy.healthCondition')} ({t('common.optional')})
              </ThemedText>
              <ThemedText variant="secondary" size="xs" style={styles.helpText}>
                {t('agent.pregnancy.healthConditionNote')}
              </ThemedText>
              <Controller
                control={step2Form.control}
                ...
                render={({ field: { onChange, onBlur, value } }) => (
                  <ThemedInput
                    placeholder={t('agent.pregnancy.healthCondition')}
                    value={value || ''}
                    onBlur={onBlur}
                    onChangeText={onChange}
                    size="md"
        ...
        <ThemedView style={styles.actionsContainer}>
          {currentStep === 1 ? (
            <PressableButton
              ...
              accessibilityLabel={t('agent.pregnancy.next')}
              style={styles.button}
            >
              {t('agent.pregnancy.next')}
            </PressableButton>
          ) : (
            <ThemedView variant="transparent" style={styles.twoButtonsRow}>
              ...
              <PressableButton
                ...
                accessibilityLabel={t('agent.pregnancy.register')}
                style={{ ...styles.button, ...styles.buttonHalf }}
              >
                {t('agent.pregnancy.register')}
              </PressableButton>
            </ThemedView>
          )}
        </ThemedView>
